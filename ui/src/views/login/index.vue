...
<script>
	...
	export default {
		...
		created: function() {
			...
			this.$TOOL.data.remove("USER_COMPANY")
...
<style scoped>
	...
	.login-form {width: 500px;margin: auto;padding:20px 0;}
	.login-header {margin-bottom: 40px;}
	.login-header .logo {display: flex;align-items: center;}
	.login-header .logo img {width: 60px;height: 40px;vertical-align: bottom;margin-right: 10px;}
