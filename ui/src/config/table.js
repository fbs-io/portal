...
export default {
	...
	parseData: function (res) {										//数据分析
		return {
			data: res.details,				//分析无分页的数据字段结构
			rows: res.details.rows,		//分析行数据字段结构
			total: res.details.total,		//分析总数字段结构
			summary: res.details.summary,	//分析合计行字段结构
			msg: res.message,			//分析描述字段结构
			code: res.errno				//分析状态字段结构
		}
	},
	request: {							//请求规定字段
